...
-- That was a lot of fun! I especially liked having to group those last queries together. I like my queries to be readable so it isn't something I'd do unless instructed, but it was fun to stretch the ol' noggin a bit.
